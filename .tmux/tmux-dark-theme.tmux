...
date_format=$(get "@onedark_date_format" "%d/%b/%Y")

set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_blue, bg=$onedark_black]${status_widgets}#[fg=$onedark_black, bg=$onedark_blue,bold]#(whoami) #[fg=$onedark_green,bg=$onedark_blue]#[fg=$onedark_black,bg=$onedark_green,bold]#h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
